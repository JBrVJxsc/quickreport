...
{
    internal partial class ucConditionValueNumeralInt : ucChangedKnownBase, Interfaces.IConditionValue, Interfaces.IConvertToXml, Interfaces.ICheckInput
    {
        public ucConditionValueNumeralInt()
        {
            InitializeComponent();
            InitOperators();
        }
        ...
        {
            get { return QuickReportCore.Objects.Condition.InputValueType.NumeralInt; }
        }
