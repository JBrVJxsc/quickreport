...
{
    public partial class ucDefaultValueNumeralDecimal : UserControl, Interfaces.IDefaultValueUserControl,Interfaces.IConvertToXml
    {
        public ucDefaultValueNumeralDecimal()
        {
            InitializeComponent();
        }
        ...
        {
            get { return QuickReport.Objects.Condition.ConditionInputType.NumeralDecimal; }
        }
        ...
        public void InitValue(QuickReport.Objects.Condition condition)
        {
            if (condition.DefaultValue == null)
                return;
            ParseFromXml(condition.DefaultValue.SelectNodes(XmlAttrDic.DefaultValueNumeralDecimal.ToString()));
        }
        ...
        {
            System.Xml.XmlElement node = Forms.frmQuickReportEditor.xmlDocument.CreateElement(XmlAttrDic.DefaultValueNumeralDecimal.ToString());
