...
namespace QuickReportCore.Managers
{
    ...
    /// 键盘与鼠标钩子。
    /// </summary>
    internal class KeyboardAndMouseHooker
    {
        public static Managers.KeyboardAndMouseHooker Hooker = new QuickReportCore.Managers.KeyboardAndMouseHooker();
        ...
        /// 构造函数。
        /// </summary>
        /// <param name="InstallMouseHook">是否使用鼠标钩子。</param>
        /// <param name="InstallKeyboardHook">是否使用键盘钩子。</param>
        public KeyboardAndMouseHooker(bool InstallMouseHook, bool InstallKeyboardHook)
        {
            Start(InstallMouseHook, InstallKeyboardHook);
        }

        ~KeyboardAndMouseHooker()
        {
