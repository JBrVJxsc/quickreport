...
{
    internal partial class BaseTextBoxForGlobalValue : TextBoxPlus , IGlobalValueToolStripItemAsker
    {
        public BaseTextBoxForGlobalValue()
        {
            InitializeComponent();
        }
        ...
        static BaseTextBoxForGlobalValue()
        {
