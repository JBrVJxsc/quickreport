...
{
    internal partial class ToolStripButtonBevelLineUp : ToolStripButtonPlus, IHeaderSettingToolStripItem
    {
        public ToolStripButtonBevelLineUp()
        {
            InitializeComponent();
        }
        ...
        protected override void OnClick(EventArgs e)
        {
            ...
            if (Checked)
            {
                ...
                foreach (BevelLine bevelLine in bevelLineList)
                {
                    if (bevelLine.StartCellRow == startCellRow && bevelLine.StartCellColumn == startCellColumn)
                    {
                        ...
                        {
                            if (bevelLine.BevelLineType == BevelLineType.Up)
                            {
            ...
            else
            {
                ...
                bevelLine.BevelLineType = BevelLineType.Up;
